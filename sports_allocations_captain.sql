...
CREATE TABLE `captain` (
  ...
  KEY `userid` (`userid`),
  KEY `teamid` (`teamid`),
  CONSTRAINT `captain_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE,
  CONSTRAINT `captain_ibfk_2` FOREIGN KEY (`teamid`) REFERENCES `team` (`teamid`) ON DELETE CASCADE
...
-- Dump completed on 2025-05-26 15:01:20
